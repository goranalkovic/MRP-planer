...
{
    public sealed partial class ReportPlannedItems : Page
    {
        ...
        public void AddTable(MrpItem item)
        {
            ...
            for (var i = 0; i < NumberOfColumns; i++)
            {
                ...
                Grid.SetRow(row2, 2);
                Grid.SetColumn(row2, i + 1);

                row2.Text = $"{colValues[i, 6]}";
      
                grd.Children.Add(row2);
            }
